...
EVENT_AUTHORED_PR_APPROVED = "azure_devops_authored_pull_request_approved"
...
EVENT_REVIEWED_PR_REVIEW_RESET = "azure_devops_review_reset_on_reviewed_pull_requests"
